...
static const char *termcmd[]  = { "st -d /home/bari/HWD", NULL };
...
//{ MODKEY,                       XK_p,              spawn,          {.v = dmenucmd } },
  ...
  { MODKEY,                       XK_semicolon,      setlayout,      {.v = &layouts[3]} }, // Sets layout to the forth element
  { MODKEY,                       XK_q,              setlayout,      {.v = &layouts[4]} }, // Sets layout to the fifth element
